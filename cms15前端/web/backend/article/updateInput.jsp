...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <form action="/backend/ArticleServlet" method="post">
                ...
                <table width="80%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题 : <input type="text" size="40"
                                                                                name="title" value="${a.title}"/><br/>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                内&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;容 : <textarea name="content" rows="10"
                                                                                   cols="42">${a.content}</textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div align="center">
                                文章来源 : <input type="text" size="40" name="source" value="${a.source}"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div align="center">
                                频道 : <select name="channelId">
                                <c:forEach items="${c}" var="t">
                                    <c:if test="${t[0] eq a.channelId}">
                                        <option value="${t[0]}" selected>${t[1]}</option>
                                    </c:if>
                                    <c:if test="${t[0] != a.channelId}">
