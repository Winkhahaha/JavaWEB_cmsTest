...
//首先把表单数据拿到
        ...
        String sql = "insert into t_article(title,content,source,createTime,author,c_id) values(?,?,?,now(),?,?)";
    ...
    public void list(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sqlCount="select count(*) from t_article";
            //查询总记录数
    ...
    public void updateInput(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql1="select * from t_channel";
        try {
            ...
            rs = prst.executeQuery();
            ArrayList<ArrayList<String>> c = DB.convertResultSet2ArrayList(rs);
