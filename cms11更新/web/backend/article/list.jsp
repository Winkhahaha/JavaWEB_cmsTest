    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <c:if test="${empty list}">
            <tr><td colspan="9">当前数据库中没有文章数据！</td></tr>
        </c:if>
        <c:if test="${not empty list}">
            <c:forEach items="${list}" var="row">
                <tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${row[5]}</div></td>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${row[4]}</div></td>
                    ...
                    <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
                        ...
                        <a href="/backend/ArticleServlet?method=updateInput&id=${row[0]}" title="点击编辑文章">编辑</a>
                    </div></td>
                </tr>
            </c:forEach>
        </c:if>
